        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView ref={scrollViewRef} onScroll={onScroll} scrollEventThrottle={16}>
                ...
                <View style={{ paddingHorizontal: 16, paddingBottom: 16 }}>
                    ...
                    <Text className="mb-4" style={{ fontSize: 16, marginTop: 8 }}>
                        {hotel.description}
                    </Text>
                    <View style={{ marginTop: 16 }}>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ width: '50%' }}>
                                <ServiceItem icon={require('../assets/images/wi-fi.png')} text="Wifi" />
                                <ServiceItem icon={require('../assets/images/cama.png')} text="Cama matrimonial" />
                            ...
                            <View className="bg-white mb-4" style={{ width: '100%', borderRadius: 20 }}>
                                ...
                                <View className="p-4">
                                    ...
                                    <View className="flex flex-row items-center ">
                                        <Image source={require('../assets/images/persona.png')} style={{ width: 20, height: 20 }} />
            ...
            {showRoomsButton && (
                ...
                <TouchableOpacity className="bg-[#395886] p-2 rounded-xl w-full " onPress={scrollToContent}>
